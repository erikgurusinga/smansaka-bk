...
<style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .period-tag { display: inline-block; padding: 2pt 10pt; background: #d1fae5; color: #065f46;
                  border-radius: 8pt; font-size: 8.5pt; font-weight: bold; }
</style>
</head>
<body>
...
<div class="subtitle">
    ...
    <span style="color: #888; margin-left: 6pt;">
        {{ $start->translatedFormat('d M Y') }} &ndash; {{ $end->translatedFormat('d M Y') }}
    </span>
</div>
...
<div class="empty-note">
    Tidak ada aktivitas layanan BK tercatat pada periode {{ $period_label }}.
</div>
@endif
...
<div class="footer-doc">
    Dicetak {{ now()->translatedFormat('d F Y, H:i') }} WIB &mdash;
    {{ $period_label }} ({{ $start->translatedFormat('d M Y') }} &ndash; {{ $end->translatedFormat('d M Y') }})
</div>

...
export default function AkpdResponses({
    students,
    classes,
    academic_years,
    total_items,
    ...
    return (
        <AuthenticatedLayout
            breadcrumbs={[
                { label: 'Instrumen BK' },
                { label: 'AKPD — Respons Siswa', href: route('akpd.responses') },
            ]}
        >
            <Head title="AKPD — Respons Siswa" />
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-0.5 text-sm text-neutral-500">
                            Isi atau lihat hasil AKPD per siswa ({total_items} butir aktif)
                        </p>
                    </div>
                    <Button variant="secondary" onClick={() => router.get(route('akpd.items'))}>
                        Kelola Butir
                    </Button>
                </div>
                                                ...
                                                <td className="px-4 py-3">
                                                    {hasAnswered ? (
                                                        <Badge variant="success">
                                                            {s.answered_count} butir dicentang
                                                        </Badge>
                                                    ) : (

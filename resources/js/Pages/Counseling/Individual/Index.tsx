...
export default function IndividualCounselingIndex({
    ...
    const confirmDelete = () => {
        ...
        setProcessing(true);
        router.delete(route('counseling.individual.destroy', deleteModal.item.id), {
            onSuccess: () => {
    ...
    return (
        ...
        >
            <Head title="Konseling Individual" />
                ...
                <div className="rounded-2xl bg-white shadow-sm ring-1 ring-neutral-100">
                    <div className="flex flex-wrap items-center justify-between gap-3 border-b border-neutral-100 p-4">
                        <div className="flex flex-wrap gap-2">
                            <SearchInput
                                placeholder="Cari topik / nama siswa..."
